...
class test_MassReaction(unittest.TestCase, MassReaction):
    ...
    def setUp(self):
        ...
        self.react1 = MassReaction("TestID1") ## basic react for testing
    ...
    def test_rate_constants(self):
        expected_value = ["kf_TestID1", "kr_TestID1"]
